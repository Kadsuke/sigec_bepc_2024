 ...
 * @author kadsuke
 */
public class TestDatabaseMergeDialogOLD extends Dialog<DatabaseList>{
    ...
    public TestDatabaseMergeDialogOLD(DatabaseList dbliste){
        this.dataBaseListe = dbliste;
        
        this.setTitle("Bilan du test de fusion");
     //   this.setHeight(25.0);
        this.setWidth(App.getScene().getHeight()-50.0);
    ...
    public TableView builBilanTableView(){
        ...
        ObservableList<BilanTestModel> data = FXCollections.observableArrayList(
            ...
            new BilanTestModel("Candidats aux poste de jury",this.dataBaseListe.getActeurKeys().size()+this.dataBaseListe.getDoublonActeurKeys().size()-((DatabaseEntity)this.dataBaseListe.getLocalDataBase()).getActeursCount(),this.dataBaseListe.getActeurKeys().size()-((DatabaseEntity)this.dataBaseListe.getLocalDataBase()).getActeursCount(),this.dataBaseListe.getDoublonActeurNIPKeys().size())
        );
    ...
    public void buildDoublonCandExTableView(){
        this.candidatExKeys = new TableColumn("ID");
    ...
    public TableView buildDoublonActeurTableView(){
        TableColumn keys = new TableColumn("ID & NIP");
        ...
        doublonTableView.setEditable(true);
    ...
    public void buildUI(){//#0096c9
        ...
        double screenWidth = screen.getBounds().getWidth()-25.0;
        double screenHeight = screen.getBounds().getHeight()-65.0;
        ...
        this.getDialogPane().setPrefHeight(screenHeight);
