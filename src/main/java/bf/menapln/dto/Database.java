...
public class Database{
    ...
    public void initDatabase() throws SQLException{
        ...
        this.createViewRegions();
        this.createViewProvinces();
        this.createViewCommunes();
        this.createViewVillesComposition();
        ...
        this.createViewCandidatsInscrit();
     ...
     //   this.insertMenuProfil();
        ...
        this.createViewCentreExamenSpecial();
        this.createViewAffectationCandidatJury();
 ...
 //Concours rattaché
    ...
    public void createTableEpreuve() throws SQLException{
        ...
        String sql = "CREATE TABLE IF NOT EXISTS epreuve (\n"
                ...
                + "	isParent text NOT NULL default '1' \n"
                + ");";
    ...
    public void createTableUser() throws SQLException{
        ...
        String sql = "CREATE TABLE IF NOT EXISTS user (\n"
                ...
                + "	CONSTRAINT fk_personnel_user FOREIGN KEY(session_id,personnel_id) REFERENCES personnel(session_id,personnel_id)\n"
                + ");";
    ...
    public void createTableCritereCandidatPosteJury() throws SQLException{
        ...
        String sql = "CREATE TABLE IF NOT EXISTS critereCandidatPosteJury (\n"
                ...
                + "	modalite_id integer ,\n"
                + "	PRIMARY KEY(session_id,candidat_id,structure_id,critere_id,poste_id,modalite_id),\n"
                + "	CONSTRAINT fk_criterePosteJury FOREIGN KEY(session_id,critere_id,poste_id,modalite_id) REFERENCES criterePosteJury(session_id,critere_id,poste_id,modalite_id),\n"
                + "	CONSTRAINT fk_candidatPosteJury FOREIGN KEY(session_id,structure_id,candidat_id) REFERENCES candidatPosteJury(session_id,structure_id,candidat_id)\n"
                + ");";
    ...
    + "	candidat_id integer NOT NULL ,\n"
    + "	ordre integer,\n"
    + "	PRIMARY KEY(session_id,etablissement_id,candidat_id,choixEtablissement_id,serie_id)\n"
    + "	FOREIGN KEY(session_id,etablissement_id,candidat_id) REFERENCES inscription(session_id,etablissement_id,candidat_id)\n"
    + ");";
...
public void createTableCandidat() throws SQLException{
        ...
        String sql = "CREATE TABLE IF NOT EXISTS candidat (\n"
                ...
                + "	lienPhoto text,\n"
                + "	PRIMARY KEY(session_id,etablissement_id,candidat_id)\n"
                + ");";
    ...
    public void createTableInscription() throws SQLException{
        ...
        String sql =
                ...
                + "	UNIQUE (session_id,etablissement_id,numeroDossier),\n"
                + "	PRIMARY KEY(session_id,etablissement_id,candidat_id),\n"
                + "	FOREIGN KEY(session_id,etablissement_id,candidat_id) REFERENCES candidat(session_id,etablissement_id,candidat_id),\n"
    ...
    public void createTableDispense() throws SQLException{
        ...
        String sql = "CREATE TABLE IF NOT EXISTS dispense (\n"
                ...
                + "	PRIMARY KEY(session_id,etablissement_id,candidat_id,epreuve_id),\n"
    ...
    public void createTableCandidatPosteJury() throws SQLException{
      ...
      // String sql1 = "DROP TABLE IF EXISTS candidatPosteJury;";
        String sql = "CREATE TABLE IF NOT EXISTS candidatPosteJury (\n"
                ...
                +"      UNIQUE(session_id,matricule),\n"
                +"      UNIQUE(session_id,nip),\n"
                +"      PRIMARY KEY(session_id,structure_id,candidat_id),\n"
                + "	FOREIGN KEY(session_id) REFERENCES session(session_id),\n"
                + "	FOREIGN KEY(structure_id) REFERENCES structure(structure_id),\n"
                + "	FOREIGN KEY(poste_id) REFERENCES posteMembreJury(poste_id)\n"
                + ");";
    ...
    public void createTableEpreuveCandidatPosteJury() throws SQLException{
        ...
        String sql = "CREATE TABLE IF NOT EXISTS epreuveCandidatPosteJury (\n"
                ...
                + "	structure_id integer NOT NULL,\n"
                + "	etatCandidature text NOT NULL DEFAULT 'En attente',\n"
                + "	PRIMARY KEY(session_id,structure_id,candidat_id,epreuve_id,option_id),\n"
                + "	FOREIGN KEY(session_id,structure_id,candidat_id) REFERENCES candidatPosteJury(session_id,structure_id,candidat_id),\n"
 ...
 */
 ...
 public void createTableCentreComposition() throws SQLException{
        ...
        String sql = "CREATE TABLE IF NOT EXISTS centreComposition (\n"
                ...
                + "	zone_id integer REFERENCES localite(localite_id),\n"
...
public void createTableJury() throws SQLException{
        ...
        String sql = "CREATE TABLE IF NOT EXISTS jury (\n"
                + "	jury_id integer,\n"
                + "	session_id integer NOT NULL,\n"
                + "	centreComposition_id integer NOT NULL,\n"
                ...
                + "	UNIQUE(session_id,juryLibelle),\n"//TODO A revoir pour avoir une unicité
                + "	FOREIGN KEY(session_id,centreComposition_id) REFERENCES centreComposition(session_id,etablissement_id)\n"
                + "	PRIMARY KEY(session_id,centreComposition_id,jury_id)\n"
                + ");";
    ...
    public void createTableCentreJury() throws SQLException{
        ...
        String sql = "CREATE TABLE IF NOT EXISTS centreJury (\n"
                ...
                + "	centreExamen_id integer,\n"
                + "	typeCentre text NOT NULL ,\n"
                + "	PRIMARY KEY(session_id,centreComposition_id,jury_id,centreExamen_id),\n"
                + "	FOREIGN KEY(session_id,centreComposition_id,jury_id) REFERENCES jury(session_id,centreComposition_id,jury_id),\n"
                + "	FOREIGN KEY(centreExamen_id) REFERENCES localite(localite_id)\n"
                + ");";
    ...
    public void createTableEtatJury() throws SQLException{
        ...
        String sql = "CREATE TABLE IF NOT EXISTS etatJury (\n"
                ...
                + "	PRIMARY KEY(session_id,centreComposition_id,jury_id,tourComposition_id),\n"
                + "	CONSTRAINT fk_juryEtat FOREIGN KEY(session_id,centreComposition_id,jury_id) REFERENCES jury(session_id,centreComposition_id,jury_id),\n"
    ...
    public void createTableCandidatJury() throws SQLException{
        String sql = "CREATE TABLE IF NOT EXISTS candidatJury (\n"
                ...
                + "	etablissement_id integer NOT NULL,\n" 
                + "	candidat_id integer NOT NULL,\n"             
                + "	PRIMARY KEY(session_id,centreComposition_id,jury_id,etablissement_id,candidat_id),\n"
                + "	UNIQUE(session_id,etablissement_id,candidat_id),\n"
                + "	FOREIGN KEY(session_id,centreComposition_id,jury_id) REFERENCES jury(session_id,centreComposition_id,jury_id),\n"
                + "	FOREIGN KEY(session_id,etablissement_id,candidat_id) REFERENCES inscription(session_id,etablissement_id,candidat_id)\n"
                + ");";
    ...
    public void createTablePersonnel() throws SQLException{
        ...
        String sql = "CREATE TABLE IF NOT EXISTS personnel (\n"
                ...
                + "     UNIQUE(session_id,nip),\n"
                + "     UNIQUE(session_id,matricule),\n"
                + "     PRIMARY KEY(session_id,personnel_id)"
                + ");";
    ...
    public void createTableMembreJury() throws SQLException{
        ...
        String sql = "CREATE TABLE IF NOT EXISTS membreJury (\n"
                ...
                + "	PRIMARY KEY(session_id,centreComposition_id,jury_id,personnel_id),\n"
                + "	FOREIGN KEY(poste_id) REFERENCES posteMembreJury(poste_id),\n"
                + "	FOREIGN KEY(session_id,centreComposition_id,jury_id) REFERENCES jury(session_id,centreComposition_id,jury_id),\n"
                + "	FOREIGN KEY(session_id,personnel_id) REFERENCES personnel(session_id,personnel_id)\n"
                + ");";
    ...
    public void createTableDisciplineCorrecteur() throws SQLException{
        ...
        String sql = "CREATE TABLE IF NOT EXISTS disciplineCorrecteur (\n"
                ...
                + "	jury_id integer NOT NULL,\n"
                + "	centreComposition_id integer NOT NULL,\n"
                + "	PRIMARY KEY(session_id,personnel_id,epreuve_id,option_id,centreComposition_id,jury_id),\n"
                + "	FOREIGN KEY(session_id,option_id,epreuve_id) REFERENCES epreuveOption(session_id,option_id,epreuve_id),\n"
                + "	FOREIGN KEY(session_id,personnel_id) REFERENCES personnel(session_id,personnel_id)\n"
                + ");";
 ...
 */
// ################  NEW VIEWS
public void createViewRegions() throws SQLException{
        String sql = "CREATE VIEW IF NOT EXISTS viewRegion AS\n"
                + "	SELECT l.localite_id as region_id, l.codeLocalite as codeRegion, l.nomLocalite as libelleRegion\n"
                + "	FROM localite l\n"
    ...
    public void createViewProvinces() throws SQLException{
        String sql = "CREATE VIEW IF NOT EXISTS viewProvince AS\n"
                + "	SELECT l.localite_id as province_id, l.codeLocalite as codeProvince,l.parentLocalite as ParentProvince_id, l.nomLocalite as libelleProvince\n"
                + "	FROM localite l\n"
                + "	INNER JOIN typeLocalite t ON t.typeLocalite_id = l.typeLocalite_id\n"
    ...
    public void createViewCommunes() throws SQLException{
        String sql = "CREATE VIEW IF NOT EXISTS viewCommune AS\n"
                + "	SELECT l.localite_id as commune_id, l.parentLocalite as parentCommune_id,l.codeLocalite as codeCommune, l.nomLocalite as libelleCommune\n"
                + "	FROM localite l\n"
                + "	INNER JOIN typeLocalite t ON t.typeLocalite_id = l.typeLocalite_id\n"
    ...
    public void createViewVillesComposition() throws SQLException{
        Statement stmtt = this.connexion.createStatement();
        stmtt.execute("DROP VIEW IF EXISTS viewVilleComposition;");
        String sql = "CREATE VIEW IF NOT EXISTS viewVilleComposition AS\n"
                + "	SELECT distinct l.localite_id as centreExamen_id, l.parentLocalite as parentVilleComposition_id, l.codeLocalite as codeVilleComposition, l.nomLocalite as libelleVilleComposition,s.session_id,s.annee\n"
                + "	FROM localite l\n"
                + "	INNER JOIN inscription i ON i.centreExamen_id = l.localite_id\n"
 ...
 public void createViewCandidat() throws SQLException{
        ...
        String sql = "CREATE VIEW IF NOT EXISTS viewCandidat AS\n"
                + "	SELECT c.*,i.*,sess.*,option.*,vilcompo.*,str.*,p.*\n"
                + "	FROM candidat c\n"
                + "	INNER JOIN inscription i ON i.candidat_id = c.candidat_id AND i.etablissement_id = c.etablissement_id\n"
                ...
                + "	INNER JOIN pays p ON p.pays_id = c.paysNaissance_id\n"
                + "     LEFT JOIN choixCandidat chCan ON chCan.candidat_id = i.candidat_id and chCan.etablissement_id = i.etablissement_id\n"
                + ";";
        Statement stmt = this.connexion.createStatement();
        stmt.execute(sql);
    }

    public void createViewCandidatsInscrit() throws SQLException{
        Statement stmtt = this.connexion.createStatement();
        stmtt.execute("DROP VIEW IF EXISTS viewCandidatsInscrits;");
        String sql = "CREATE VIEW IF NOT EXISTS viewCandidatsInscrits AS\n"
                ...
                +"situation.*,\n"
                +"i.numeroDossier,i.sport,i.dernierDiplome,i.anneeDernierDiplome,i.concoursRattache,c.nomPere,c.prenomPere,c.nomMere,c.prenomMere,i.telephone,i.telephoneDeux,\n"
                +"pn.pays_id,pn.nomPays,nat.pays_id as nationalite_id,nat.nationalite,gp.groupePedagogique_id as gp_id,gp.groupePedagogiqueLibelle as gpLibelle,tcand.*,tinsc.*,option.*,th.*,nh.natureHandicap_id,nh.natureHandicapLibelle,\n"
                +"presc.*,reg.*,prov.*,com.*,villeCompo.*,z.localite_id as zone_id,z.nomLocalite as libelleZone,\n"
                +"con.concoursRattache_id,con.concoursRattacheLibelle,\n"
                +"choix.choixEtablissement_id as etabChoix_id,choixEtabCandi.nomStructure as etabChoix_nom,\n"
                +"choixEtabCandi.acronymeStructure as etabChoix_accronyme, \n"
                +"choixSerieCandi.serie_id as serieChoix,choixSerieCandi.serieLibelle\n"
                +"FROM candidat c\n"
                +"INNER JOIN session s ON s.session_id = c.session_id\n"
                +"INNER JOIN structure str ON str.structure_id = c.etablissement_id\n"
                +"INNER JOIN inscription i ON i.session_id = c.session_id and i.candidat_id = c.candidat_id and i.etablissement_id = c.etablissement_id\n"
                +"INNER JOIN typeSituation situation ON situation.typeSituation_id = i.typeSituation_id\n"
                +"INNER JOIN pays pn ON pn.pays_id = c.paysNaissance_id\n"
                +"INNER JOIN pays nat ON nat.pays_id = c.paysNationalite_id\n"
                +"INNER JOIN groupePedagogique gp ON gp.groupePedagogique_id = i.groupePedagogique_id and gp.etablissement_id = i.etablissement_id and gp.session_id = i.session_id\n"
                +"INNER JOIN typeCandidat tcand ON tcand.typeCandidat_id = i.typeCandidat_id\n"
                +"INNER JOIN typeInscription tinsc ON tinsc.typeInscription_id = i.typeInscription_id\n"
                +"INNER JOIN option ON option.option_id = i.option_id\n"
                +"LEFT JOIN natureHandicap nh ON nh.natureHandicap_id = i.natureHandicap_id\n"
                +"LEFT JOIN prescription presc ON presc.prescription_id = i.prescription_id\n"
                +"LEFT JOIN typeHandicap th ON th.typeHandicap_id = nh.typeHandicap_id\n"
                +"INNER JOIN viewCommune com ON com.commune_id = str.localite_id\n"
                +"INNER JOIN viewProvince prov ON prov.province_id = com.parentCommune_id\n"
                +"INNER JOIN viewRegion reg ON reg.region_id = prov.parentProvince_id\n"
                +"INNER JOIN viewVilleComposition villeCompo ON villeCompo.centreExamen_id = i.centreExamen_id\n"
                +"INNER JOIN localite z ON z.localite_id = i.zone_id\n"
                +"LEFT JOIN concoursRattache con ON con.concoursRattache_id = i.concoursRattache\n"
                +"LEFT JOIN choixCandidat choix ON choix.candidat_id = i.candidat_id AND choix.etablissement_id = i.etablissement_id\n"
                +"LEFT JOIN structure choixEtabCandi ON choixEtabCandi.structure_id = choix.choixEtablissement_id\n" 
                +"LEFT JOIN serie choixSerieCandi ON choixSerieCandi.serie_id = choix.serie_id" 
                + ";";
    ...
    public void createViewCandidatPosteJury() throws SQLException{
        ...
        String sql = "CREATE VIEW IF NOT EXISTS viewCandidatPosteJury AS\n"
                + "	SELECT cpj.*,ecpj.*,e.*,opt.optionLibelle,opt.optionDefinition,sess.*,str.*,poste.*,\n" +
                ...
                "	LEFT JOIN option opt ON opt.option_id= ecpj.option_id\n" +
                "	LEFT JOIN epreuveOption epOp ON epOp.epreuve_id = ecpj.epreuve_id AND opt.option_id= epOp.option_id\n" +
                ...
                "       LEFT JOIN localite commu ON commu.localite_id = str.localite_id\n" +
...
public void createViewAffectationMembreJury() throws SQLException{
    ...
    public void createViewCentreExamenJury() throws SQLException{
        Statement stmtt = this.connexion.createStatement();
        stmtt.execute("DROP VIEW IF EXISTS viewCentreExamenJury;");
        String sql = "select centJ.session_id,\n"
        +"centJ.jury_id,\n"
        +"centJ.centreExamen_id,\n"
        +"centJ.typeCentre,\n"
        +"centreExa.nomLocalite,\n"
        +"parentn1.localite_id as parentn1_id,\n"
        +"parentn1.nomLocalite as libelleParentn1,\n"
        +"parentn2.localite_id as parentn2_id,\n"
        +"parentn2.nomLocalite as libelleParentn2,\n"
        +"parentn3.localite_id as parentn3_id,\n"
        +"parentn3.nomLocalite as libelleParentn3\n"
        +" from centreJury centJ\n"
        +"  LEFT JOIN localite centreExa ON centreExa.localite_id = centJ.centreExamen_id\n"
        +" left join localite parentn1 on centreExa.parentLocalite = parentn1.localite_id\n"
        +"left join localite parentn2 on parentn1.parentLocalite = parentn2.localite_id\n"
        +"left join localite parentn3 on parentn2.parentLocalite = parentn3.localite_id\n"
        +";";
    }
    ...
    public void createViewAffectationCandidatJury() throws SQLException{
        ...
        String sql = "CREATE VIEW IF NOT EXISTS viewAffectationCandidatJury AS\n"
                + "SELECT c.*,i.*,sess.*,option.*,centreExa.localite_id as centreExamenId,centreExa.nomLocalite as libelleCentreExamen,\n"
               +" cjury.typeCentre,\n"
               +" str.*,j.*,\n"
               +" typeLo.typeLocalite_id,\n"
       +" typeLo.typeLocaliteLibelle,\n"
       +" parentn1.localite_id as parentn1_id,\n"
       +" parentn1.nomLocalite as libelleParentn1,\n"
       +" parentn2.localite_id as parentn2_id,\n"
       +" parentn2.nomLocalite as libelleParentn2,\n"
       ...
       +"  INNER JOIN session sess ON sess.session_id = i.session_id\n"
       +"  INNER JOIN option ON option.option_id = i.option_id\n"
       +"  LEFT JOIN candidatJury cj ON cj.candidat_id = c.candidat_id AND cj.etablissement_id=c.etablissement_id\n"
       +"  LEFT JOIN localite centreExa ON centreExa.localite_id = i.centreExamen_id\n"
       +"  left join localite parentn1 on centreExa.parentLocalite = parentn1.localite_id\n"
       +" left join localite parentn2 on parentn1.parentLocalite = parentn2.localite_id\n"
       +" left join localite parentn3 on parentn2.parentLocalite = parentn3.localite_id\n"
       +" inner join typeLocalite typeLo on centreExa.typeLocalite_id = typeLo.typeLocalite_id\n"
       ...
       +" LEFT JOIN typeHandicap typeH ON typeH.typeHandicap_id = natureH.typeHandicap_id\n"
        +" LEFT JOIN jury j ON j.jury_id = cj.jury_id\n"
         +"left join centreJury cjury on cjury.centreExamen_id = centreExa.localite_id\n"
                + ";";
        Statement stmt = this.connexion.createStatement();
        stmt.execute(sql);
    }
...
//        stmtt.execute("DROP VIEW IF EXISTS viewEpreuveOption;");
    ...
    public void createViewJury() throws SQLException{
        ...
        String sql = "CREATE VIEW IF NOT EXISTS viewJury AS\n"
                ...
                + "                inner join centreComposition cc on cc.etablissement_id = cj.centreComposition_id\n"
                + "                inner join localite centres on centres.localite_id = cj.centreExamen_id\n"
                + "                INNER JOIN structure str ON cj.centreComposition_id = str.structure_id\n"
...
"        LEFT JOIN typeHandicap typeH ON typeH.typeHandicap_id = natureH.typeHandicap_id;";
    ...
    public void createViewCentreExamenSpecial() throws SQLException{
        Statement stmtt = this.connexion.createStatement();
        stmtt.execute("DROP VIEW IF EXISTS viewCentreExameSpecial;");
        String sql = "CREATE VIEW IF NOT EXISTS viewCentreExameSpecial AS\n"
                + "select distinct insc.centreExamen_id,\n " 
               + "insc.session_id,\n"
               + "cent.nomLocalite,\n"
               + "typeLo.typeLocalite_id,\n"
               + "typeLo.typeLocaliteLibelle,\n"
               ...
               + "from inscription insc\n"
                +"inner join localite cent on insc.centreExamen_id = cent.localite_id\n"
                +"left join localite parentn1 on cent.parentLocalite = parentn1.localite_id\n"
                +"left join localite parentn2 on parentn1.parentLocalite = parentn2.localite_id\n"
                +"left join localite parentn3 on parentn2.parentLocalite = parentn3.localite_id\n"
                +"inner join typeLocalite typeLo on cent.typeLocalite_id = typeLo.typeLocalite_id\n"
                + ";";
        Statement stmt = this.connexion.createStatement();
        stmt.execute(sql);
    }
